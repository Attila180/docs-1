...
`),s("span",Ps,[s("span",fs,"  rest: '"+l(a.constants.mochaRestUrl)+"'",1)]),n(`
`),vs,n(`
`),Ns,n(`
...
`),s("span",Zs,[s("span",Ls,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Qs,n(`
`),Ws,n(`
