...
`),H,n(`
`),j,n(`
`),G])]),s("pre",O,[s("code",null,[L,n(`
`),z,n(`
`),J,n(`
`),s("span",Y,[s("span",Q,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),W,n(`
...
`),bs,n(`
`),qs,n(`
`),s("span",gs,[s("span",ks,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),Ds,n(`
...
`),Os,n(`
`),s("span",Ls,[s("span",zs,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
